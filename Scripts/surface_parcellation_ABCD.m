function  surface_parcellation_ABCD(cohortfile,tmasklist,subsample,dosubcort,outputdir)
...
%
% TOL 01/25/13, modified by EMG 06/24/15 & SM 10/02/18


% PARAMETERS TO SET
smooth = 2.55; % sigma for geodesic smoothing applied to gradient maps
workbenchdir = '/data/nil-bluearc/GMT/Scott/workbench/bin_rh_linux64/'; %location of workbench
...
for s = 1:length(subjects)
    ...
    if s==1
        ...
        subcounter_eachpoint = zeros(size(fullgrads,1),num_samples,'single');
